"""Prompt builder for the MLA (Medical Legal Appointments) document extraction agent."""
...
- "Our Reference:", "Our Ref:", "Agency Ref:", "Agency Reference:", or "Ref:" in header → agency_ref
...
- "Your Ref:", "Your Reference:", "Solicitor Reference:", or "OICP Reference:"         → instructor_reference
...
- Distinguish between the SENDER (Agency) and the RECIPIENT (Solicitor/Instructor) using the letterhead and address blocks.
- "Our Reference" usually belongs to the SENDER → agency_ref.
- "Your Reference" usually belongs to the RECIPIENT → instructor_reference.
...
- When in doubt, OIC/OICP formatted references are typically the portal/instructor references.
